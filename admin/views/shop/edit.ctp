...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-content">
        ...
        <div class="tab-content default-tab" id="tab2">
             ...
             <?php echo $form->create(null, array( 'url' => DOMAINAD.'Shop/edit','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?>       
					 ...
					 <p>
					  ...
					  <p>
                        <label>Ảnh đại diện </label>
                         <input type="text" size="50" value="<?php echo $edit['Shop']['images']?>" class="text-input medium-input datepicker" name="userfile1" readonly="true"> &nbsp;<font color="#FF0000"> <a href="javascript:window.open('<?php echo DOMAINAD; ?>upload_pic.php?stt=1','userfile1','width=500,height=300');window.history.go(1)" >[ upload ]</a> </font><font color="#FF0000">*</font>(jpg, jpeg, gif, png)
                    </p>
                   ...
                   <p>
					  ...
					  <p>
                        ...
                        <label>Chọn mã cửa hàng</label>
						  ...
						  <option value="<?php echo $edit['Shop']['companyname']?>" ><?php echo $edit['Shop']['companyname']?></option>
					...
					<p>
                        <label>Chọn nhóm</label>
						  ...
						  <?php $category=explode('|',$edit['Shop']['category_code']);
						  
						  foreach($category as $key=>$value){ if($value!='') {?>
						  
						<tr>
							<td><label><?php echo $value;?></label></td>
							<td> <input type="checkbox" name="chuoi[<?php echo $key;?>]" checked>
							</td>
						</tr>
                    ...
                    <p>
                        <label>Trạng thái</label>
                         ...
                         <?php echo $form->input('Shop.id',array('label'=>''));?>  
                    </p>
                    <p>

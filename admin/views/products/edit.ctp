           ...
           <?php echo $form->create(null, array( 'url' => DOMAINAD.'products/edit','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?>       
                ...
                <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                    <p>
                       ...
                       <p>
                        <label>Tên cửa hàng</label>
                           <?php echo $form->input('Product.title1',array( 'label' => '','class'=>'text-input medium-input datepicker'));?>
                    </p>
                  ...
                  <label for="date1">Ngày bắt đầu giảm giá:</label>
                     <input type="text" name="date_batdau" value="<?php if ($this->data['Product']['date_batdau']!='') echo $this->requestAction('products/dinhdangngay/'.$this->data['Product']['date_batdau']);?>" class="popupDatepicker datepicker" style="width:200px;"/>
                  ...
                  <input type="text" name="date_ketthuc" class="popupDatepicker1 datepicker" style="width:200px;" value="<?php if($this->data['Product']['date_ketthuc']) echo $this->requestAction('products/dinhdangngay/'.$this->data['Product']['date_ketthuc']);?>"/>

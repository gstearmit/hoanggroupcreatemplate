...
if (confirm("Bạn có muốn xóa danh mục này không!"))
{
 ...
 <?php echo $form->create(null, array( 'url' => DOMAINAD.'products/search_kho','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?> 
     <fieldset class="search">
        ...
        <p style="text-align:center;"> <input type="submit" name="" value="Thống kê" class="button" /></p>
                ...
                <tbody>
                   ...
                   foreach ($product as $key =>$value){?>
                    <tr>
                        ...
                        <td>
                        <?php echo $html->link( $value['Product']['title'], '/products/view/'.$value['Product']['id']);?>

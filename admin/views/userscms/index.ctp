            ...
            <table>
                ...
                <thead>
                    <tr>
                       ...
                       <th>STT</th>
                       <th><?php echo $this->Paginator->sort('Email','id');?></th>
                       <th>Họ tên</th>
						<th>Số điện thoại</th>
						<th>Giới tính</th>
						<th>Ngày sinh</th>				   
                ...
                <tbody>
				   ...
				   ?>
                    <tr>
                        ...
                        <td> <?php echo $value['Userscm']['email'];?></td>
                       <td> <?php echo $value['Userscm']['name'];?></td>
                        <td> <?php echo $value['Userscm']['phone'];?></td>
                         <td> <?php  if($value['Userscm']['sex']==1) echo "Nam"; else echo"Nữ";?></td>
						
						<td> <?php echo $value['Userscm']['birth_date'];?></td>
                        ...
                        <td><?php echo date('d-m-Y', strtotime($value['Userscm']['created'])); ?></td>
						 ...
						 <p style="padding-left:15px;">
                             <?php if($value['Userscm']['den']==0){?>
							 
							     
                              	    
                           
                                 <a href="<?php echo DOMAINAD?>Userscms/active1/<?php echo $value['Userscm']['id'] ?>" title="Kích hoạt" class="icon-5 info-tooltip"><img src="<?php echo DOMAINAD?>images/icons/Play-icon.png" alt="Kích hoạt" /></a>
                            <?php } else {?>
							
                             	  
                           
                                 <a href="<?php echo DOMAINAD?>Userscms/close1/<?php echo $value['Userscm']['id'] ?>" title="Đóng" class="icon-4 info-tooltip"><img src="<?php echo DOMAINAD?>images/icons/success-icon.png" alt="Ngắt kích hoạt" /></a>

...
if ($_REQUEST['txid'] != '') {
	...
	$query = "INSERT INTO " . $table_prefix . "orders(`order`, `request`, `datetime`, `affiliation`, `total`, `tax`, `shipping`, `city`, `state`, `country`) VALUES('{$_REQUEST['txid']}', '$request_id', NOW(), '{$_REQUEST['affil']}', '{$_REQUEST['total']}', '{$_REQUEST['tax']}', '{$_REQUEST['ship']}', '{$_REQUEST['city']}', '{$_REQUEST['state']}', '{$_REQUEST['country']}')";

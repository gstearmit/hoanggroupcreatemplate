...
<div id='body'>
     ...
     <ul>
			...
			<li><a href="<?php echo DOMAIN?>">Trang chủ</a></li>
		 	...
		 	<li class="l-i"><a href="<?php echo DOMAIN?>deal-hot"> Deal hot</a></li>		
...
<div class="addthis_toolbox addthis_default_style" style="padding-left:21px; padding-top:23px; overflow:hidden">
...
<!-- AddThis Button END -->
                ...
                <div class="div-tg">
                    ...
                    <div id='time'>Thời gian còn lại<span></br>
